...
begin
  try
    ...
    FRepo.RelatorioAbastecimentos(FDQueryRel, edtData1.Date, edtData2.Date, FSelectedTanqueId, FSelectedBombaId);
...
var
  ...
  sDisplay: string;
begin
  ComboTanque.Items.BeginUpdate;
  try
    ComboTanque.Items.Clear;
    ComboTanque.Items.AddObject('',TObject(0));
    Q := TFDQuery.Create(nil);
    try
      Q.Connection := FRepo.GetConnection;
