...
begin
  ...
  try
    ...
    try
      ...
      Q.SQL.Text :=
        'INSERT INTO ABASTECIMENTO (BOMBA_ID, DATA_HORA, QUANTIDADE_LITROS, VALOR_LITRO, VALOR_BRUTO, VALOR_IMPOSTO) ' +
        'VALUES (:BOMBA_ID, :DATA_HORA, :QUANTIDADE_LITROS, :VALOR_LITRO, :VALOR_BRUTO, :VALOR_IMPOSTO)';
      Q.ParamByName('BOMBA_ID').AsInteger := A.BombaId;
      Q.ParamByName('DATA_HORA').AsDateTime := A.DataHora;
      Q.ParamByName('QUANTIDADE_LITROS').AsFloat := A.QUANTIDADELitros;
      ...
      Q.ParamByName('ESTOQUE_ATUAL_L').AsFloat := A.QuantidadeLitros;
...
begin
  ...
  Q.SQL.Add('   B.CODIGO||'' - ''||B.DESCRICAO AS BOMBA,');
  Q.SQL.Add('  AVG(A.VALOR_LITRO) AS VALOR_MEDIO_LITRO,');
  Q.SQL.Add('  SUM(A.QUANTIDADE_LITROS) AS TOTAL_LITROS,');
  Q.SQL.Add('  SUM(A.VALOR_BRUTO) AS TOTAL_BRUTO,');
  Q.SQL.Add('  SUM(A.VALOR_IMPOSTO) AS TOTAL_IMPOSTO,');
  Q.SQL.Add('  SUM(A.VALOR_BRUTO - A.VALOR_IMPOSTO) AS TOTAL_LIQUIDO');
